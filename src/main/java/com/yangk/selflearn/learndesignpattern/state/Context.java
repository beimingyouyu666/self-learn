package com.yangk.selflearn.learndesignpattern.state;
...
public class Context {
    ...
    public void setState(AbstractState state) {
        this.state = state;
        /*这个地方在debug的时候，会出现 Method threw 'java.lang.StackOverflowError' exception. Cannot evaluate com.yangk.selflearn
        .learndesignpattern.state.SimpleClient.toString()
