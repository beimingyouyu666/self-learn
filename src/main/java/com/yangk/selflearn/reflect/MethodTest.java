...
public class MethodTest {
    ...
    /**
     * 一个完整方法包含的属性有： 方法上使用的注解、方法的修饰符、方法上定义的泛型参数、
     * 方法的返回值、方法名称、方法参数(泛型、注解)、方法抛出的异常
     */
    @MyAnnotationClass
    private <T> boolean add(@MyAnnotationParamter List<T> list, T... params) throws RuntimeException,
            Exception {
        if (null == list) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Method add = clazz.getDeclaredMethod("add", List.class);
    ...
    private static void getMethodInfo(Method method) {
        ...
        boolean annotationPresent = method
                .isAnnotationPresent(MyAnnotationClass.class);
        if (annotationPresent) {
            MyAnnotationClass myAnnotationClass = method
                    .getDeclaredAnnotation(MyAnnotationClass.class);
        }
        // 2、方法的修饰符
        ...
        //打印 @reflect.MyAnnotationClass(intValue=0)
