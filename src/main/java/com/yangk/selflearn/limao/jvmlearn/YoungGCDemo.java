 ...
 * -XX:+PrintGCTimeStamps -Xloggc:gc-metaspaceover.log”
 * <p>
 * -- 原始日志
 ...
 * -XX:NewSize=5242880 -XX:OldPLABSize=16 -XX:PretenureSizeThreshold=10485760 -XX:+PrintGC -XX:+PrintGCDetails
 * -XX:+PrintGCTimeStamps -XX:SurvivorRatio=8 -XX:+UseCompressedClassPointers -XX:+UseCompressedOops
 * -XX:+UseConcMarkSweepGC -XX:-UseLargePagesIndividualAllocation -XX:+UseParNewGC
 * 0.289: [GC (Allocation Failure) 0.289: [ParNew: 3998K->511K(4608K), 0.0045648 secs] 3998K->2105K(9728K), 0.0047063
 ...
 * -XX:OldPLABSize=16 -XX:PretenureSizeThreshold=10485760
